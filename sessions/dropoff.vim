...
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/emmet-vim,~/.vim/bundle/vim-virtualenv,~/.vim/bundle/nerdtree,~/.vim/bundle/vim-colorschemes,~/.vim/bundle/vim-fugitive,~/.vim/bundle/jedi-vim,~/.vim/bundle/SimpylFold,~/.vim/bundle/vim-markdown,/usr/local/Cellar/macvim/7.4-73_1/MacVim.app/Contents/Resources/vim/vimfiles,/usr/local/Cellar/macvim/7.4-73_1/MacVim.app/Contents/Resources/vim/runtime,/usr/local/Cellar/macvim/7.4-73_1/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/emmet-vim/after,~/.vim/bundle/vim-virtualenv/after,~/.vim/bundle/nerdtree/after,~/.vim/bundle/vim-colorschemes/after,~/.vim/bundle/vim-fugitive/after,~/.vim/bundle/jedi-vim/after,~/.vim/bundle/SimpylFold/after,~/.vim/bundle/vim-markdown/after
set shiftwidth=4
set softtabstop=4
...
silent only
cd ~/Documents/DropOff-Web
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +68 shop/api/views.py
badd +5 shop/api/permissions.py
badd +0 shop/api/serializers.py
argglobal
silent! argdel *
edit shop/api/serializers.py
...
exe 'vert 1resize ' . ((&columns * 31 + 128) / 257)
exe 'vert 2resize ' . ((&columns * 112 + 128) / 257)
exe 'vert 3resize ' . ((&columns * 112 + 128) / 257)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 47 - ((1 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
47
normal! 0
lcd ~/Documents/DropOff-Web
wincmd w
argglobal
edit ~/Documents/DropOff-Web/shop/api/views.py
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <expr> <C-Space> jedi#complete_string(0)
nnoremap <buffer> <silent> K :call jedi#show_documentation()
